            ...
            <div class="col-md-4">
                <div class="card text-center mb-4">
                    <div class="card-body">
                        ...
                        <form action="/owner/screen-seats/<%= screen.getId() %>" method="get" class="d-inline-block">
                            <button class="btn btn-primary" type="submit">Show Seats</button>
                        </form>
                        <form action="/owner/manage-shows/<%= screen.getId() %>" method="get" class="d-inline-block ml-2">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="addScreenForm" action="/owner/add-screen/<%= multiplexId %>" method="post">
